...
<%@page import="java.util.List"%>
        ...
        List<model.bookingsbean> list=model.dbCon.getallrooms();  
          
        out.print("<table border='1' width='100%'");  
        out.print("<tr><th>Roomno</th><th>Username</th><th></th><th></th>");  
        for(model.bookingsbean c:list){  
         out.print("<tr><td>"+"&nbsp "+c.getroomno()+"</td><td>"+"&nbsp"+c.getroomuname()+"</td><td> <form action='./paymentmailservlet' method='post'><input type='hidden' name='uname' value="+c.getroomuname()+"><input type='text' name='amount' value='Amount'> <input type='submit' value='Send Payment Notification'>  </form></td><td><form action='./delrooms' method='post'><input type='hidden' name='delrooms' value="+c.getroomno()+"> <input type='submit' value='Check-out'>  </form></td> </tr>");  
        }  
        out.print("</table>");  
