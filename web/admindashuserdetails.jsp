...
<%@page import="java.util.List"%>
        ...
        List<model.userdetailsbean> list=model.dbCon.getuserdetails();  
          
        out.print("<table border='1' width='100%'");  
        out.print("<tr><th>Username</th><th>Fullname</th><th>Email</th><th>Phone No</th><th>Gender</th><th></th>");  
        for(model.userdetailsbean e:list){  
         out.print("<tr><td>"+"&nbsp "+e.getusername()+"</td><td>"+"&nbsp"+e.getfullname()+"</td><td>"+"&nbsp "+e.getemail()+"</td><td>"+"&nbsp "+e.getphno()+"</td><td>"+"&nbsp "+e.getgender()+"</td><td> <form action='./delusers' method='post'><input type='hidden' name='username' value="+e.getusername()+"> <input type='submit' value='Delete'>  </form></td></tr>");  
        }  
        out.print("</table>");  
